<?php
/**
 * Redesigned FIX4U home (preview under BeTheme child).
 *
...
$hero = betheme_fix4u_img( 'hero.jpg' );
?>
<style>
.hero {
	background: linear-gradient(135deg, rgba(135, 206, 235, 0.92) 0%, rgba(227, 242, 253, 0.95) 100%),
		url('<?php echo esc_url( $hero ); ?>') center/cover;
}
</style>

<section class="hero">
	<div class="container">
		<h1>Your Devices, <span>Our Expertise</span></h1>
		<p>Professional phone &amp; computer repair, instant trade-in, and quality used devices. Fast service, fair prices, guaranteed satisfaction.</p>
		<div class="hero-btns">
		...
		<div class="services-grid">
			...
			foreach ( $services as $svc ) :
				...
				<div class="service-card">
					<img src="<?php echo esc_url( betheme_fix4u_img( $svc[0] ) ); ?>" alt="<?php echo esc_attr( $svc[1] ); ?>" class="service-img">
		...
		<div class="services-grid">
			<div class="service-card">
				<div class="service-content">
					...
					<p style="margin-top:15px;color:var(--primary);font-weight:600;">From $899</p>
				</div>
			</div>
			<div class="service-card">
				<div class="service-content">
					...
					<p style="margin-top:15px;color:var(--primary);font-weight:600;">From $1,899</p>
				</div>
			</div>
		</div>
	...
	<div class="container">
		...
		<div class="contact-grid">
			<div class="contact-info">
				<h3>Get In Touch</h3>
				<div class="contact-item"><span>📍</span><div><strong>Location</strong><br>1 Cebel Place, Rosedale, Auckland</div></div>
				<div class="contact-item"><span>📱</span><div><strong>Phone</strong><br><a href="tel:0800800349">0800 800 349</a></div></div>
				<div class="contact-item"><span>✉️</span><div><strong>Sales</strong><br><a href="mailto:info@fix4u.co.nz">info@fix4u.co.nz</a></div></div>
				<div class="contact-item"><span>🛠️</span><div><strong>Support</strong><br><a href="mailto:support@fix4u.co.nz">support@fix4u.co.nz</a></div></div>
			</div>
			<div class="contact-info">
